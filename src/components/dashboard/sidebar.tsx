...
import { BarChart3, FileText, LayoutDashboard, PanelsTopLeft, Search } from "lucide-react"
import { cn } from "@/lib/utils"
import logoImage from "../../../logo.jpg"

const menuItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/" },
  { icon: BarChart3, label: "Sản Phẩm Xuất Kho", href: "/production-clone" },
  { icon: PanelsTopLeft, label: "Đối Soát Hoàn Hủy", href: "/hoan-huy-demo" },
  { icon: Search, label: "Tra cứu đơn hàng", href: "/search" },
  { icon: FileText, label: "Tìm File PDF Đơn", href: "/pdf-search" },
      ...
      <div className="group mb-6">
        <Link href="/" className="block">
          <Image
            ...
            alt="XMKN"
            priority
            className="h-auto w-40 rounded-xl object-contain transition-transform duration-300 group-hover:scale-[1.02]"
          />
        </Link>
      </div>
