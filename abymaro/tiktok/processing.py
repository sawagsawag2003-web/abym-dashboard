...
import os
try:
    # Cố gắng import normalize_variant để dùng lại logic phân loại nếu cần
...
def process_and_group_pdf(mixed_pages_list):
    """
    Hàm xử lý chính: Gộp file, Sắp xếp và Vẽ hình.
    LOGIC MỚI: Dựa vào Order ID để ghép nối Trang Main và Trang Phụ.
    Phân loại thư mục dựa trên SẢN PHẨM ĐẦU TIÊN của trang Main.
    """
    groups = {}
