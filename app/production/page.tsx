    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-3 pt-16 md:p-4 lg:ml-64 lg:p-5 lg:pt-0">
        <div className="space-y-2">
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Thống Kê Sản Lượng</h1>
          <p className="max-w-3xl text-sm leading-6 text-muted-foreground">
            Theo dõi sản lượng theo danh mục sản phẩm và phân loại cấp 2 trong khoảng thời gian đã chọn.
          </p>
        </div>
